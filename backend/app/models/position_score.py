...
class PositionScore(Base):
    ...
    # 技术面详情
    trend_direction = Column(String)  # BULLISH/BEARISH/SIDEWAYS
    trend_strength = Column(Integer)
    rsi_value = Column(Float)
    rsi_status = Column(String)  # OVERSOLD/NEUTRAL/OVERBOUGHT
    ...
    valuation_grade = Column(String)  # A/B/C/D/F
    profitability_grade = Column(String)

    # AI总结
    technical_summary = Column(Text)
    fundamental_summary = Column(Text)
    recommendation = Column(String)  # BUY/HOLD/REDUCE/SELL
